...
Pod::Spec.new do |s|
  ...
  s.source_files = 'SymbiOSis/SymbiOSis.h', 'SymbiOSis/Core/*', 'SymbiOSis/Bindings/*', 'SymbiOSis/Responders/*', 'SymbiOSis/Private/*'
  s.public_header_files = 'SymbiOSis/SymbiOSis.h', 'SymbiOSis/Core/*', 'SymbiOSis/Bindings/*', 'SymbiOSis/Responders/*'
  s.frameworks = 'UIKit'
end
